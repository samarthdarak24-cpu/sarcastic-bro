...
export default function TraceabilityPage() {
  ...
  return (
    <DashboardLayout navItems={buyerNav} userRole="BUYER">
      <div className="p-6">
        <h1 className="text-3xl font-bold text-slate-900 mb-6">Blockchain Traceability</h1>
        <p className="text-slate-600 mb-4">Product ID: {productId}</p>
        <BlockchainTraceLive userRole="BUYER" />
      </div>
    </DashboardLayout>
  );
}
