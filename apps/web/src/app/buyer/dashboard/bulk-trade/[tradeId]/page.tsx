...
export default function BulkTradeDetailPage() {
  ...
  return (
    <DashboardLayout navItems={buyerNav} userRole="BUYER">
      <div className="p-6">
        <h1 className="text-3xl font-bold text-slate-900 mb-6">Bulk Trade Details</h1>
        <p className="text-slate-600 mb-4">Trade ID: {tradeId}</p>
        <BulkOrders />
      </div>
    </DashboardLayout>
  );
