...
import { 
  ...
  ArrowUpCircle, Calendar 
} from 'lucide-react';

export default function FPOWalletPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6">FPO Wallet</h1>

      {/* Balance Card */}
      <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg shadow-lg p-8 mb-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-purple-100 mb-2">Commission Balance</p>
            <p className="text-4xl font-bold">
              ₹{wallet?.balance.toLocaleString() || 0}
            </p>
          </div>
          <WalletIcon className="w-16 h-16 text-purple-200 opacity-50" />
        </div>
        ...
        <div className="mt-6">
          <button
            ...
            className="bg-white text-purple-600 px-6 py-2 rounded-lg font-medium hover:bg-purple-50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Withdraw to Bank
          </button>
        </div>
