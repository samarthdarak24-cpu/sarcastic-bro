...
import { Brain, TrendingUp, Target, Zap, BarChart3, Sparkles, Activity, AlertCircle } from "lucide-react";
...
export function AgriIntelligenceBuyer() {
  const stats = [
    { label: "Market Signals", value: "24", icon: Target, color: "blue", bgColor: "bg-blue-50", textColor: "text-blue-600" },
    { label: "Price Alerts", value: "8", icon: TrendingUp, color: "emerald", bgColor: "bg-emerald-50", textColor: "text-emerald-600" },
    { label: "AI Predictions", value: "96%", icon: Brain, color: "indigo", bgColor: "bg-indigo-50", textColor: "text-indigo-600" },
    { label: "Insights", value: "156", icon: Sparkles, color: "amber", bgColor: "bg-amber-50", textColor: "text-amber-600" },
  ];
